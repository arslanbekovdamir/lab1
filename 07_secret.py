...
#   подробную информацию об обратных срезах см 
#
# Подсказки:
...
for i in range(len(secret_message)):
    if i == 0:
        a = secret_message[i][3]
        a += " "
    if i == 1:
        a += secret_message[i][9:13]
        a += " "
    if i == 2:
        a += secret_message[i][5:14:2]
        a += " "
    if i == 3:
        a += secret_message[i][7:13][::-1]
        a += " "
    if i == 4:
        a += secret_message[i][16:21][::-1]
print(a)
