...
couchs_cost = store[goods['Диван']][0]['quantity'] * store[goods['Диван']][0]['price']
# или проще (/сложнее ?)
couch_code = goods['Диван']
couchs_item = store[couch_code][0]
couchs_quantity = couchs_item['quantity']
couchs_price = couchs_item['price']
couchs_cost = couchs_quantity * couchs_price
print('Диван -', couchs_quantity, 'шт, стоимость', couchs_cost, 'руб')
